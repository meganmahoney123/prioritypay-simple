...
export async function GET() {
  ...
  const { data: allocations, error } = await admin
    ...
    .select("id, label, amount, calculated_amount, status, dest_account_id, dest_account_label, source_account_id, source_account_label, confirmed_at, simple_transfers!inner(id, source_amount, created_at, user_id)")
