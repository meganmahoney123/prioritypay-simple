...
// SMS deposit alerts are live: PriorityPay sends them via Telnyx's toll-free
// number (see lib/sms.js) once it has cleared Toll-Free Verification. Email
// alerts (sendDepositAlertEmail below) still send alongside as a second
// channel. This flag only ungates the feature globally -- each send still
// additionally requires the user's own opt-in (sms_notifications_enabled +
// phone_number) and a deposit over their threshold, checked at the call site.
