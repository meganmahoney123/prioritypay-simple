...
export const DEFAULT_SPLIT_RULES = {
  ...
  fixed: [],
  // Seven starting categories, matching PriorityPay's own Solo 401k / SEP
  // IRA / Investments / Tax Reserve / Emergency Fund / OPEX / Savings --
  ...
  percent: [
    { id: "solo_401k", label: "Solo 401k", group: "Investments", pct: 10, max: null, color: "#8b5cf6", accountId: null, retirementType: "solo_401k" },
    { id: "sep_ira", label: "SEP IRA", group: "Investments", pct: 5, max: null, color: "#ec4899", accountId: null, retirementType: "sep_ira" },
    { id: "investments", label: "Investments", group: "Investments", pct: 10, max: null, color: "#14b8a6", accountId: null },
