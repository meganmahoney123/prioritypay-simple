...
// (see how lib/stripe.js is the only SDK in this codebase, for the one
// rail that genuinely needs it). Same lazy-config spirit as stripeClient()
...
// companies and configs -- so we resolve each field by its ColTitle first,
// then ColType (see the colIdx comment below for why both), rather than a
// positional guess, and walk nested section rows defensively (same reasoning
// as fetchNetIncomeForMonth's row walk).
