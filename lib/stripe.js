...
//
// Built lazily (not at module load) -- next build imports every route
// module to collect metadata before real env vars are necessarily set,
// and the Stripe SDK constructor doesn't like being handed `undefined`.
let _client = null;
