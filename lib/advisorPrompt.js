...
export const ADVISOR_SYSTEM_PROMPT = `You are the PriorityPay Tax Strategy Assistant, built into the PriorityPay app.
...
asserting relevance, the same way a good guide would rather than reciting
